...
public interface AmpUserRepository extends PagingAndSortingRepository<AmpUser, Long>{
	...
	@Query(value = "select u from AmpUser u where u.state = :state and u.id not in :idsExcluded and (" + 
	...
	List<AmpUser> findByStatusAndNameStartsWithAndUserIdNotInOrderByName(State state, String nameStarting, List<Long> idsExcluded);
	List<AmpUser> findByStatusAndLastNameStartsWithIgnoreCaseAndUserIdNotInOrderByLastNameFirstNameUsername(State state, String nameStarting, List<Long> idsExcluded);
	List<AmpUser> findByStatusAndFirstNameStartsWithIgnoreCaseAndUserIdNotInOrderByLastNameFirstNameUsername(State state, String nameStarting, List<Long> idsExcluded);
	List<AmpUser> findByStatusAndUsernameStartsWithIgnoreCaseAndUserIdNotInOrderByLastNameFirstNameUsername(State state, String nameStarting, List<Long> idsExcluded);
